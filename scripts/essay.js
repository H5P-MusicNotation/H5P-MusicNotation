...
const EssayScore4LMS = (function () {
 ...
 // const SOLUTION_SAMPLE = 'h5p-essay-solution-sample';
   ...
   */
  function EssayScore4LMS(config, contentId, contentData) {
    // Initialize
    if (!config) {
      return;
    }
    ...
    // Sanitize defaults
    this.params = EssayScore4LMS.extend(
      {
        media: {},
        taskDescription: '',
        //solution: {},
  ...
  EssayScore4LMS.prototype.constructor = EssayScore4LMS;
   ...
   */
  EssayScore4LMS.prototype.addButtons = function () {
    const that = this;
   ...
   */
  EssayScore4LMS.prototype.getInput = function (linebreakReplacement) {
   ...
   */
  EssayScore4LMS.prototype.handleInteracted = function (params) {
    params = params || {};
  ...
  /**
   * Check if EssayScore4LMS has been submitted/minimum length met.
   * @return {boolean} True, if answer was given.
   * @see contract at {@link https://h5p.org/documentation/developers/contracts#guides-header-1}
   */
  EssayScore4LMS.prototype.getAnswerGiven = function () {
   ...
   */
  /*EssayScore4LMS.prototype.getMaxScore = function () {
    // Return value is rounded because reporting module for moodle's H5P plugin expects integers
   ...
   */
  EssayScore4LMS.prototype.showSolutions = function () {
   ...
   */
  EssayScore4LMS.prototype.resetTask = function () {
   ...
   */
  EssayScore4LMS.prototype.getXAPIData = function () {
    return {
   ...
   */
  EssayScore4LMS.prototype.isPassed = function () {
    return true;//(this.params.behaviour.ignoreScoring || this.getScore() >= this.scorePassing);
  };
...
*/
   ...
   * @param {boolean} [params.skipXAPI = false] If true, don't trigger xAPI.
   */
  EssayScore4LMS.prototype.handleEvaluation = function (params) {
    params = EssayScore4LMS.extend({
      skipXAPI: false
    }, params);
   ...
   */
  EssayScore4LMS.prototype.buildSolution = function () {
   ...
   * Hide the solution.
   */
  EssayScore4LMS.prototype.hideSolution = function () {
   ...
   */
  EssayScore4LMS.prototype.computeResults = function () {
    const that = this;
    const results = [];
    ...
    /*this.params.keywords.forEach(function (alternativeGroup) {
      ...
      const regularExpressionMatches = that
        ...
        .map(function (match) {
          ...
          return match = match.replace(/\*\/, EssayScore4LMS.REGULAR_EXPRESSION_ASTERISK);
        });
   ...
   */
  EssayScore4LMS.prototype.buildExplanation = function (results) {
    const explanations = [];
...
//    });
   ...
   */
  EssayScore4LMS.prototype.handleButtons = function (score) {
   ...
   * @param {number} score - Score the user received.
   */
  EssayScore4LMS.prototype.handleXAPI = function () {
  ...
  /**
   * Create an xAPI event for EssayScore4LMS.
   * @param {string} verb - Short id of the verb we want to trigger.
   * @return {H5P.XAPIEvent} Event template.
   */
  EssayScore4LMS.prototype.createEssayXAPIEvent = function (verb) {
    const xAPIEvent = this.createXAPIEventTemplate(verb);
    EssayScore4LMS.extend(
   ...
   */
  EssayScore4LMS.prototype.getxAPIDefinition = function () {
    const definition = {};
    definition.name = {};
    ...
    definition.description[this.languageTag] = this.params.taskDescription + EssayScore4LMS.FILL_IN_PLACEHOLDER;
    // Fallback for h5p-php-reporting, expects en-US
   ...
   */
  EssayScore4LMS.prototype.getXAPIAnswerEvent = function () {
   ...
   */
  EssayScore4LMS.prototype.detectExactMatches = function (needle, haystack) {
    ...
    needle = needle
      ...
      .replace(new RegExp(EssayScore4LMS.REGULAR_EXPRESSION_ASTERISK, 'g'), '*'); // Asterisk from regexp
   ...
   * @return {Object[]} Results: [{'keyword': needle, 'match': needle, 'index': front + pos}*].
   */
  EssayScore4LMS.prototype.detectWildcardMatches = function (needle, haystack, caseSensitive) {
    if (needle.indexOf('*') === -1) {
      return [];
    }
   ...
   */
  EssayScore4LMS.prototype.detectFuzzyMatches = function (needle, haystack) {
   ...
   */
  EssayScore4LMS.prototype.getRegExpAlternatives = function (alternatives, inputTest, caseSensitive) {
    const that = this;
   ...
   */
  EssayScore4LMS.prototype.getRegExpModifiers = function (caseSensitive) {
    const modifiers = ['g'];
    if (!caseSensitive) {
      modifiers.push('i');
    }
   ...
   */
  EssayScore4LMS.prototype.mergeMatches = function () {
    // Sanitization
   ...
   */
  EssayScore4LMS.prototype.contains = function (results, index) {
   ...
   */
  EssayScore4LMS.extend = function () {
    for (let i = 1; i < arguments.length; i++) {
   ...
   * @return {string} Title.
   */
  EssayScore4LMS.prototype.getTitle = function () {
    let raw;
    if (this.extras.metadata) {
      raw = this.extras.metadata.title;
    }
    raw = raw || EssayScore4LMS.DEFAULT_DESCRIPTION;
   ...
   */
  EssayScore4LMS.formatLanguageCode = function (languageCode) {
   ...
   */
  EssayScore4LMS.prototype.htmlDecode = function (input) {
   ...
   */
  EssayScore4LMS.prototype.getCurrentState = function () {
    if (!this.inputField) {
   ...
   */
  EssayScore4LMS.prototype.setViewState = function (state) {
    if (EssayScore4LMS.VIEW_STATES.indexOf(state) === -1) {
      return;
    }
   ...
   * thai chars: \u0E00-\u0E7F
   */
  EssayScore4LMS.CHARS_WILDCARD = '[A-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF\u0370-\u03FF\u0400-\u04FF\u3040-\u309F\u3040-\u30FF\u4E00-\u62FF\u6300-\u77FF\u7800-\u8CFF\u8D00-\u9FFF\u0E00-\u0E7F]';

  /** @constant {string}
   * Required to be added to xAPI object description for H5P reporting
   */
  EssayScore4LMS.FILL_IN_PLACEHOLDER = '__________';

  /** @constant {string} */
  EssayScore4LMS.DEFAULT_DESCRIPTION = 'EssayScore4LMS';

  /** @constant {string} */
  EssayScore4LMS.REGULAR_EXPRESSION_ASTERISK = ':::H5P-EssayScore4LMS-REGEXP-ASTERISK:::';
